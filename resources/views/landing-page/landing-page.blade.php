...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        @include('landing-page.partials.navbar-land')
        ...
        <!-- About Start -->
        @include('landing-page.partials.about-land')
        <!-- About End -->


        <!-- Service Start -->
        @include('landing-page.partials.program-land')
        <!-- Service End -->


        <!-- Testimonial Start -->
        @include('landing-page.partials.testimoni-land')
        <!-- Testimonial End -->


        <!-- Team Start -->
        @include('landing-page.partials.team-land')
        <!-- Team End -->
            ...
            <div class="container px-lg-5">
                <div class="row align-items-center" style="height: 250px;">
                    ...
                    <div class="col-md-6 text-center mb-n5 d-none d-md-block">
                        <img class="img-fluid mt-5" style="height: 250px;" src="landing-agency/img/newsletter.png">
                    </div>
                </div>
            </div>
        </div>
        ...
        <!-- Footer Start -->
        @include('landing-page.partials.footer-land')
        <!-- Footer End -->
