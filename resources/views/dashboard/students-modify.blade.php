      ...
      <div class="card-body py-0 px-0 px-sm-3">
        <div class="row align-items-center">
          ...
          <div class="col-5 col-sm-7 col-xl-8 p-0">
            <h2 class="mb-1 mb-sm-0">STUDENTS - MODIFY</h2>
          </div>
...
<div class="col-lg-12 grid-margin stretch-card">
  <div class="card">
    <div class="card-body">
      <h4 class="card-title">ACTIVE STUDENT UPDATE</h4> 
      @if (session('status'))
        ...
        <table class="table table-dark">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{{$user->phone}}</td>
              <td>
                <a href="/dashboard/modify/{{$user->id}}" type="button" class="btn btn-warning btn-icon-text mb-2">
                  <i class="mdi mdi-reload btn-icon-prepend"></i> Edit </a>

                  <form action="/dashboard/modify/delete/{{$user->id}}" method="POST">
                    @csrf
                    @method('DELETE')
