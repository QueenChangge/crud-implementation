    ...
    :root {
      ...
      *::after {
      ...
      .card-header {
        ...
        margin-bottom: 0;
        background-color: rgba(160, 78, 78, 0.03);
...
<a href="https://imgbb.com/"><img src="{{ asset('storage/faces/'.Auth::user()->profile_photo_path) }}" alt="image" border="0"width="220" height="220"></a>
				    <img class="mr-3 img-fluid picture mx-auto" src="assets/images/фотощька.jpg" alt="">
				    <div class="media-body p-4 d-flex flex-column flex-md-row mx-auto mx-lg-0">
					    <div class="primary-info">
						    <h1 class="name mt-0 mb-1 text-uppercase" style="color: #434E5E">
                                {{-- {{Auth::user()->civi->fullname}} --}}
                                Anak Agung Ayu Citra Maharani
                            </h1>
						    <div class="title mb-3">{{Auth::user()->civi->target_position}}</div>
						    <ul class="list-unstyled" >
							    <li class="mb-2" style="color: #434E5E"><a href="mailto:zveryanovstanis@gmail.com" style="color: #434E5E"><i class="far fa-envelope fa-fw mr-2"  style="color: #434E5E" data-fa-transform="grow-3"></i>{{Auth::user()->civi->email}}</a></li>
		    ...
		    <div class="resume-body p-5">
			    <section class="resume-section summary-section mb-5">
				    ...
				    <div class="resume-section-content">
					    <p class="mb-0">{{Auth::user()->civi->aboutme}}</p>
				    </div>
			    </section>
			    <div class="row">
				    <div class="col-lg-9">
				    ...
				    <div class="col-lg-3">
                        <section class="resume-section interests-section mb-5">
						    ...
						    <div class="resume-section-content">
							    <ul class="list-unstyled">
								    <li class="mb-1">Fullname :<br>
                                        {{-- {{Auth::user()->civi->fullname}} --}}
                                        Anak Agung Ayu Citra Maharani
                                    </li>
								    <li class="mb-1">Place/Date of Birth :<br>
                                    {{Auth::user()->civi->place_of_birth}}/{{Auth::user()->civi->date_of_birth}}
                                    </li>
								    <li class="mb-1">Address :<br>
                                        {{Auth::user()->civi->address}}
                                    </li>
								    <li class="mb-1">Nationality :<br>
                                        {{Auth::user()->civi->nationality}}
                                    </li>
                                    <li class="mb-1">Gender :<br>
                                        {{Auth::user()->civi->gender}}
                                    </li>
                                    <li class="mb-1">Weight/Hight :<br>
                                        {{Auth::user()->civi->weight}}/{{Auth::user()->civi->hight}}</li>
                                    <li class="mb-1">Nationality :<br>
                                        {{Auth::user()->civi->nationality}}
                                    </li>
                                    <li class="mb-1">Religion :<br>
                                        {{Auth::user()->civi->religion}}
                                    </li>
                                    <li class="mb-1">Marital Status :<br>
                                        {{Auth::user()->civi->marital_status}}
                                    </li>
							    </ul>
						    </div>
					    </section>
