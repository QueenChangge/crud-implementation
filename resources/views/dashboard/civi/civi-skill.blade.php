      ...
      <div class="card-body py-0 px-0 px-sm-3">
        <div class="row align-items-center">
          ...
          <div class="col-5 col-sm-7 col-xl-8 p-0">
            <h2 class="mb-1 mb-sm-0">CV - INPUT SKILL</h2>
          </div>
        </div>
      </div>
    </div>
...
<div class="col-md-8 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <form class="forms-sample mb-3" method="POST" action="/dashboard/cv/skill">
          @csrf
            ...
            <table class="table table-dark mb-2">
              ...
              <tbody>
                ...
                <tr>
                    ...
                    <td>{{$skill->name}}</td>
                    <td>
                          <form action="/dashboard/cv/skill-delete/{{$skill->id}}" method="POST">
                            @csrf
                            @method('DELETE')
